...
class Bootstrap extends CApplicationComponent
{
	...
	{
		// Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/classic.css');
		// Yii::app()->clientScript->registerCssFile($this->getAssetsUrl().'/css/classic.date.css');
	}
	...
	public function registerJS($position = CClientScript::POS_END)
	{
		/** @var CClientScript $cs */
		$cs = Yii::app()->getClientScript();
        $cs->registerScriptFile($this->getAssetsUrl().'/js/jquery-3.3.1.min.js', CClientScript::POS_END);
        $cs->registerScriptFile($this->getAssetsUrl().'/js/jquery.relcopy.yii.4.0.js',CClientScript::POS_END);
        $cs->registerScriptFile($this->getAssetsUrl().'/js/bootstrap.bundle.min.js', CClientScript::POS_END);
        $cs->registerScriptFile($this->getAssetsUrl().'/js/perfect-scrollbar.min.js', CClientScript::POS_END);
        $cs->registerScriptFile($this->getAssetsUrl().'/js/echarts.min.js', CClientScript::POS_END);
        $cs->registerScriptFile($this->getAssetsUrl().'/js/echart.options.min.js', CClientScript::POS_END);
        $cs->registerScriptFile($this->getAssetsUrl().'/js/dashboard.v1.script.min.js', CClientScript::POS_END);
        $cs->registerScriptFile($this->getAssetsUrl().'/js/script.min.js', CClientScript::POS_END);
	}
